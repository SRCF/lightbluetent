...
Revision ID: 6acc09e8039c
Revises: 
Create Date: 2020-10-04 01:05:13.256089
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                ...
                "CAN_CREATE_OWN_ROOMS",
                "CAN_DELETE_OWN_ROOMS",
                "CAN_MANAGE_OWN_ROOMS",
                "CAN_START_OWN_ROOMS",
                "CAN_JOIN_WHITELISTED_ROOMS",
                name="permissiontype",
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("VISITOR", "USER", "ADMINISTRATOR", name="roletype"),
            nullable=False,
        ),
        sa.Column("description", sa.String(), nullable=True),
        sa.Column("updated_at", sa.DateTime(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "authentication",
            sa.Enum("PUBLIC", "RAVEN", "PASSWORD", "WHITELIST", name="authentication"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "recur",
            sa.Enum("NONE", "DAILY", "WEEKDAYS", "WEEKLY", name="recurrence"),
            nullable=False,
        ),
